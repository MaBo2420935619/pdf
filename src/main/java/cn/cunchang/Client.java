...
import cn.cunchang.rule.PasswordReplace;
...
public class Client {
    ...
    static {
        ReplaceRule bankCardReplace = new PasswordReplace();
        // 招商银行
        bankRuleMap.put("处方金额", bankCardReplace);
        bankRuleMap.put("医师", bankCardReplace);
        bankRuleMap.put("科室", bankCardReplace);
        bankRuleMap.put("ID", bankCardReplace);
